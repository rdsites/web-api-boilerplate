...
export function RegisterRoutes(app: express.Express) {
    ...
    app.get('/api/v1/usuarios/group/:group',
        authenticateMiddleware([{ "api_key": [] }]),
        function(request: any, response: any, next: any) {
            const args = {
                group: { "in": "path", "name": "group", "required": true, "dataType": "string" },
            };
            ...
            const promise = controller.getByGroup.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    app.post('/api/v1/usuarios',
        ...
        function(request: any, response: any, next: any) {
            const args = {
                usuario: { "in": "body", "name": "usuario", "required": true, "ref": "UsuarioModel" },
            };
